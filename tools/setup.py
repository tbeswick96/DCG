...
def main():
    ...
    print("""
  #######################################
  # DCG Development Environment Setup #
  #######################################

  This script will create your DCG dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your DCG project folder:
    [Arma 3 installation directory]\\{} => DCG project folder
    P:\\{}                              => DCG project folder
...
if __name__ == "__main__":
    ...
    if exitcode > 0:
        print("\nSomething went wrong during the setup. Make sure you run this script as administrator. If these issues persist, please follow the instructions on the DCG wiki to perform the setup manually.")
    else:
